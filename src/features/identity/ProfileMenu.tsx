...
export function ProfileMenu() {
  ...
  return (
    <div ref={menuRef} className="relative inline-block text-left">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-72 bg-white border border-neutral-200 shadow-2xl rounded-none overflow-hidden z-[200] animate-in fade-in zoom-in-95 duration-100">
          ...
          <div className="p-3">
            <button
              ...
              className="w-full h-8 text-[12px] font-bold text-neutral-800 bg-neutral-50 hover:bg-rose-50 hover:text-rose-700 border border-neutral-200 hover:border-rose-200 rounded-none transition-colors cursor-pointer text-center"
            >
              Log out
            </button>
          </div>
