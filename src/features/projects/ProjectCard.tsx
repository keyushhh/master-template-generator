...
export function ProjectCard({ project, index }: ProjectCardProps) {
  return (
    <motion.article
      className="group flex min-h-60 flex-col rounded-[var(--radius-xl)] border border-border-default bg-surface-panel p-6 shadow-[var(--shadow-xs)] transition-colors hover:border-action-primary"
