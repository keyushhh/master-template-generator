...
client: PlanView
title: Partner Advocacy Program
subtitle: APAC Partner Amplification Proposal
date: 2026 // Q3 Proposal
tagline: Activating the PlanView partner ecosystem across APAC through structured advocacy campaigns.
---
...
- PartnerView pilot consumed under 200 of 300 credits

## Key Metric

- value: 2.0
- unit: M
- title: Total potential reach in one campaign week

Benchmark from the Veeam partner-network campaign: partners and their employees flooded LinkedIn with brand content for seven days straight.

## Metrics

Campaign momentum compounds across the week as partners join.

- bar: Day 1 | 30
- bar: Day 3 | 45
- bar: Day 5 | 70
- bar: Day 7 | 95 | active
- kpi: Total Shares | 1,282
- kpi: Asset Clicks | 1,187
- kpi: Engagements | 15,000+

## Comparison

- row: Campaign Window | 7 Days | 1–2 Months | Sustained
- row: Advocates | Employees Only | Partners + Employees | Ecosystem-wide
- row: Content Mapping | One Story | Per-Partner Narrative | Personalised
- row: Follower Growth | Untracked | Showcase Page KPI | Redirection On

## Roadmap

- phase: Pilot | Two-month partner campaign across July and August with posts every one to two weeks. | done
- phase: Expand | Onboard the wider APAC partner ecosystem with partner-specific narratives and challenges. | 
- phase: Sustain | Quarterly always-on advocacy anchored to flagship moments like PartnerView and PlanView Day. | 
...
Confirmed and tentative activity across the region.

- sector: Australia | 2 Confirmed Events
- sector: New Zealand | PlanView Day
- sector: Middle East | IDC or GITEX
...
Proposal and commercials to follow, including the Veeam partner-network case study and masked Salesforce campaign dashboards. Next review: partner-level post preview session on Monday.
